...
- **type**: [`StorageLike`](https://github.com/zvonimirsun/pinia-plugin-persistedstate/blob/main/src/types.ts#L8)
...
- **type**: [`Serializer`](https://github.com/zvonimirsun/pinia-plugin-persistedstate/blob/main/src/types.ts#L23)
